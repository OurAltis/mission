...
_result = ["INSERT INTO ereignisse (runde, partei, gebiet, fall, bau, person, waffe) VALUES ('" + str(GVAR(round)) + "','" + _sideDB + "','" + GVAR(targetAreaName) + "','supCol','','" + _name + "','')"] call FUNC(transferSQLRequestToDataBase);
