...
private _westUnits = {(side group _x) isEqualTo west} count (allUnits inAreaArray _markerFOB);
private _eastUnits = {(side group _x) isEqualTo east} count (allUnits inAreaArray _markerFOB);
