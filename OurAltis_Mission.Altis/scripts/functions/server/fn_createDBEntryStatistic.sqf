...
private _result = ["INSERT INTO statistik (mission_id, operation, partei, zeit_soll, zeit_ist, sitemission, ger_verloren, inf_verloren, spieler_stats, treibstoff) VALUES (" + _parameter + ")"] call FUNC(transferSQLRequestToDataBase);
