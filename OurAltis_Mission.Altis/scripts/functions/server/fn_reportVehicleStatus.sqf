...
private _health = floor ((1 - getDammage _vehicle) * 100);
...
private _result = ["UPDATE armeen SET bestand = '" + str _health + "', tank = '" + str _fuel + "' WHERE id = '" + str _id + "'"] call FUNC(transferSQLRequestToDataBase);
